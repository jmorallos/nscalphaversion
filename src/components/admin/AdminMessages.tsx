    ...
    return (
      <Card className="max-w-2xl mx-auto">
        <CardContent className="p-12 text-center">
          ...
          <h3 className="text-xl mb-2">No Conversations</h3>
          <p className="text-gray-600">
            Conversations will appear here when students submit requests.
          </p>
        </CardContent>
      </Card>
    );
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-gray-600">Communicate with students about their requests</p>
      </div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-1">
                      <div className="flex-1">
                        <p className="text-sm truncate">{conv.studentName}</p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {selectedConversation.documentType.toUpperCase()} - Request ID: {selectedConversation.id.substring(0, 8)}...
                    </p>
                  </div>
