...
import { GraduationCap, Home, FileText, MessageSquare, HelpCircle, LogOut, Menu } from 'lucide-react';
...
export function StudentDashboard({ user, onLogout }: StudentDashboardProps) {
  ...
  const navigation = [
    ...
    { id: 'request', label: 'Request Document', icon: FileText },
    { id: 'track', label: 'Track Request', icon: FileText },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-4 lg:p-6">
          {activeTab === 'overview' && <StudentOverview user={user} onNavigate={setActiveTab} />}
          {activeTab === 'request' && <RequestDocument user={user} onNavigate={setActiveTab} />}
          {activeTab === 'track' && <TrackRequest user={user} onNavigate={setActiveTab} />}
